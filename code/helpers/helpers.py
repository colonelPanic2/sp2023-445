...
def time_data(args,state,step,t0=0,noprint=0,logfile=None,num_samples=None):
    ...
    if args=='time':
        if step==0:
            ...
            microcontroller_time_data={'START':0,'WAIT':0,'CHASE':0,'ACQUIRE':0,'FETCH':0,'RETURN':0}
            no_print=noprint
            log_file = logfile
            ...
            writefile(log_file,"ANALYSIS OF RUNTIME DATA:\n")
